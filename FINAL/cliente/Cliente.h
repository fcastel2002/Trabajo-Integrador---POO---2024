...
public:
    ...
    bool enviarComando(Orden& my_order, ErrorHandler& errorHandler);  // Añadir ErrorHandler
    std::vector<std::string> pedirComandos(Orden& my_order, ErrorHandler& errorHandler);  // Añadir ErrorHandler
