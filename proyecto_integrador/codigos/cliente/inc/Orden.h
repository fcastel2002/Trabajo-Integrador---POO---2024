...
public:
     ...
     * @param parametros Vector de vectores de strings que representan los par�metros de la orden.
     */
    explicit Orden(const std::vector<std::vector<std::string>>& parametros) : m_parametros{ parametros } {}

    /**
     * Crea una orden en formato XmlRpcValue a partir de los par�metros proporcionados.
